...
ExcessDemand(R)  = K_Agg(xxx,xxx,par,mpar,Π,meshes,gri)[1] - 0   # Calculate the difference between capital supply and demand for wages and returns given by assumed capital demand
